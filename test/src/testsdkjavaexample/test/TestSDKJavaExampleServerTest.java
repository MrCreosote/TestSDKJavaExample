package testsdkjavaexample.test;
...
import testsdkjavaexample.FilterContigsParams;
import testsdkjavaexample.FilterContigsResults;
import testsdkjavaexample.TestSDKJavaExampleServer;
...
public class TestSDKJavaExampleServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static TestSDKJavaExampleServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("TestSDKJavaExample");
        ...
        JsonServerSyslog.setStaticMlogFile(new File(config.get("scratch"), "test.log")
            .getAbsolutePath());
        impl = new TestSDKJavaExampleServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_TestSDKJavaExample_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("TestSDKJavaExample").withMethod("please_never_use_it_in_production")
